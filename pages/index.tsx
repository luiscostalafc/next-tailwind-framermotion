...
export default function Home() {
  return (
    <div>
      <h1 className="text-4x1 sm:text-6xl lg:text-7xl mt-10 md:mt-24 leading-none font-extrabold tracking-tight text-gray-900">Contrua sites modernos com agilidade sem precisar sair do HTML.
      </h1>
